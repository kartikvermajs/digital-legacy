...
export default function Settings() {
  ...
  const handleUpdateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      queryClient.setQueryData(['me'], { ...userData, ...profile });
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      queryClient.setQueryData(['me'], { ...userData, avatarUrl: newAvatarUrl });
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#0f172a,#1e1b4b,#4c1d95)] font-sans text-white flex">
      <aside className="w-72 hidden md:flex flex-col border-r border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.02)] backdrop-blur-3xl sticky top-0 h-screen p-8">
        <Link href="/" className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#8b5cf6] to-[#a78bfa] mb-12 hover:opacity-80 transition-opacity block w-fit">
          Digital Legacy
        </Link>
        ...
        <nav className="flex flex-col gap-4 flex-1">
          ...
          <Link href="/pricing" className="px-4 py-3 rounded-xl text-[#cbd5f5] hover:bg-[rgba(255,255,255,0.05)] hover:text-white transition-all">
            Pricing
          </Link>
        </nav>
      ...
      <main className="flex-1 p-8 sm:p-12 overflow-y-auto w-full">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <Link href="/dashboard" className="inline-flex items-center gap-2 text-sm font-medium text-[#a78bfa] hover:text-white transition-colors">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-10">
            ...
            <div className="relative group shrink-0 cursor-pointer">
              <label className="block relative w-28 h-28 rounded-full overflow-hidden transition-all group-hover:border-[#a78bfa]">
                ...
                {profile.avatarUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-[#cbd5f5] transition-all duration-300 group-hover:brightness-50">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
                  <div className="bg-white/10 p-3 rounded-full shadow-lg">
