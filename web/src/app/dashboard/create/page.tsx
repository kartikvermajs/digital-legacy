        ...
        <div className="w-full max-w-2xl p-8 sm:p-10 rounded-3xl bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] backdrop-blur-xl shadow-[0_0_40px_rgba(124,58,237,0.15)]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center gap-2 mb-2">
              <div 
                className="w-28 h-28 rounded-[24px] border-2 border-dashed border-[rgba(255,255,255,0.2)] bg-[rgba(0,0,0,0.2)] flex flex-col items-center justify-center text-[#cbd5f5] hover:border-[#a78bfa] hover:text-[#a78bfa] transition-colors group shadow-inner hover:cursor-not-allowed"
                title="AI Reference Upload - Coming Soon"
              >
                <svg className="w-8 h-8 mb-2 group-hover:scale-110 transition-transform opacity-60" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span className="text-[10px] font-bold uppercase tracking-wider opacity-80">Add Photo</span>
              </div>
              <p className="text-xs text-[#cbd5f5]/60 text-center uppercase tracking-wide font-medium">
                AI Reference (Coming Soon)
              </p>
            </div>
